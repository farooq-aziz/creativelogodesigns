...
import HeroBanner from "media/new-lp-2/heroBanner.png"
// Components
...
const Hero = ({ content }) => {
    ...
    return (
        <section>
            <div className="bg-[#F7F7F7] pt-[150px] lg:pb-[50px]">
                <div className="container">
                    <div className="flex items-end justify-between flex-wrap lg:flex-nowrap gap-x-5 gap-y-10 lg:gap-y-0">
                        ...
                        <div className="basis-full lg:basis-1/2 md:block hidden">
                            <Image src={HeroBanner} alt="Icons"/>
                        </div>
                    </div>
                </div>
            </div>
