                        ...
                        <TabsBody>
                            <TabPanel value="one" className="flex gap-5 items-center">
                                <div className="basis-full lg:basis-[65%] xl:basis-[60%]">
                                    <h2 className="text-[25px] lg:text-[40px]  font-megat font-extrabold leading-tight text-white mb-2">
                                        Logo Infinite
                                    </h2>
                                    ...
                                    <div className="md:flex gap-3 xl:gap-5 mt-10">
                                        <ul>
                                            {combo1A && combo1A.map((e, i) => (
                                                <li className="text-[14px] text-white font-normal flex items-start gap-2 leading-[24px] mb-3"
                                                    key={i}>
