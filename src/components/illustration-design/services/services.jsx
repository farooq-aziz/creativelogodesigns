        ...
        <div className="container">
          <div className="lg:w-2/3 mb-10">
            <span className="text-base font-normal text-red">
              Hire Illustration Designers
            </span>
            <h2 className="text-[20px] sm:text-[25px] xl:text-[35px] font-megat font-extrabold leading-tight text-black mb-2">
              ILLUSTRATION DESIGN SERVICES THAT HELP YOUR BRAND TO STAND OUT.
            </h2>
            <p className="text-base text-black font-normal">
              When you hire illustration designers from Creative Logo Designs,
              you tap into a wealth of artistic talent and creativity, ensuring
              impeccable results for your brand.
            </p>
          </div>
